...
class LoginView extends Component {
  ...
  responseHandler = (response, body) => {
    if (response == 'success' && body.data.hasOwnProperty('token')) {
      sessionStorage.setItem('token', body.data.token)
      sessionStorage.setItem('user_id', body.data.user.id)
      sessionStorage.setItem('user_rol', body.data.user.rol)
      sessionStorage.setItem('user_name', body.data.user.name)
      sessionStorage.setItem('user_email', body.data.user.email)
          ...
          <div className='lg-content'>
            ...
            <div className='lg-header'>
              <span className='lg-title'>
                Bienvenido a la aplicación de LinkScribe
              </span>
